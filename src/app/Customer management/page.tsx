...
const notifications = [
  ...
  },
  {
    ...
    message: "A customer record was deleted.",
    time: "1 hr ago",
    type: "warning",
  },
  {
    ...
    message: "A customer was flagged for review.",
    time: "2 hrs ago",
    type: "error",
  },
];
...
const CustomerNotificationPage = () => {
  return (
    <div className="p-8 w-full h-full">
      <h2 className="text-2xl font-bold text-indigo-950 mb-6">Customer Notifications</h2>
